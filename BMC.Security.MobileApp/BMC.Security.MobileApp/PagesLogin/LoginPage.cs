...
using BMC.Security.MobileApp.CustomEventArgs;
...
namespace BMC.Security.MobileApp.PagesLogin
{
    public class LoginPage : BaseMediaContentPage<LoginViewModel>
    {
        ...
        readonly StyledButton _loginButton, _newUserSignUpButton, _HomeAutomationButton;
        ...
        public LoginPage()
        {
            try
            {
                ...
                _HomeAutomationButton = new StyledButton(Borders.None) { Text = "Home Automation" };
        ...
        void OpenHomePage() => Device.BeginInvokeOnMainThread(async () => await Navigation.PushModalAsync(new Pages.WebView()));

        void HandleHomeAutomationClicked(object sender, EventArgs e) => OpenHomePage();
